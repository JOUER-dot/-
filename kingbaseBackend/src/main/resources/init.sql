-- ============================================================
-- KingbaseES 初始化脚本（PostgreSQL 兼容语法）
-- 数据库: finance (请在 KingbaseES 中预先创建)
-- Schema: app
-- ============================================================
-- 连接到目标数据库后执行:
--   psql -U system -d finance -f init.sql
-- 或使用 KingbaseES 客户端工具执行本脚本
-- ============================================================
set schema 'app';

/*
-- Source: RoboAdvisor Backend
-- Target: KingbaseES (PostgreSQL Compatible)
*/

-- 外键约束在表创建完成后统一处理
-- KingbaseES 下无需设置 NAMES
...
CREATE TABLE "advisor_product"  (
                                    ...
                                    "published_version_no" int NULL DEFAULT NULL,
...
CREATE TABLE "advisor_product_nav"  (
                                        ...
                                        "cum_return" decimal(18, 8) NULL DEFAULT NULL,
                                        "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY ("id"),
...
CREATE TABLE "advisor_product_rule_decision"  (
                                                  ...
                                                  "reviewer_id" bigint NOT NULL,
                                                  "override_min_fund_count" int NULL DEFAULT NULL,
                                                  "override_max_fund_count" int NULL DEFAULT NULL,
                                                  "override_max_single_weight" decimal(10, 4) NULL DEFAULT NULL,
                                                  ...
                                                  INDEX "fk_rule_decision_rule"("base_rule_id"),
                                                  INDEX "fk_rule_decision_reviewer"("reviewer_id"),
...
CREATE TABLE "advisor_product_subscription"  (
                                                 ...
                                                 "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                 "updated_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                 "invest_amount" decimal(16, 2) NULL DEFAULT 0.00,
                                                 "current_value" decimal(16, 2) NULL DEFAULT 0.00,
                                                 PRIMARY KEY ("id"),
...
CREATE TABLE "advisor_strategy_rule"  (
                                          ...
                                          "min_fund_count" int NOT NULL,
                                          "max_fund_count" int NOT NULL,
                                          "min_single_weight" decimal(10, 4) NOT NULL,
                                          "max_single_weight" decimal(10, 4) NOT NULL,
...
CREATE TABLE "fund_nav"  (
                             ...
                             "nav_date" date NOT NULL,
                             "nav" decimal(18, 8) NOT NULL,
                             "daily_return" decimal(18, 8) NULL DEFAULT NULL,
                             "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
                             PRIMARY KEY ("id"),
